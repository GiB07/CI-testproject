                            ...
                            <table id="cartTable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($orders as $value):
                                        ...
                                        echo '<button type="button" class="btn btn-md glass-btn btn-warning" style="padding: 1px 10px; font-size: 14px;" onclick=edit("")><i class="bi bi-pencil"></i> Edit</button>';
                                        echo '&nbsp;';
                                        echo '<button type="button" class="btn btn-md glass-btn btn-danger" style="padding: 1px 10px; font-size: 14px;" onclick=remove("")><i class="bi bi-trash"></i> Remove</button>';
                                        echo '</td>';
                                        echo '</tr>';
